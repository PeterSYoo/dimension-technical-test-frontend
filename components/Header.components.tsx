...
export const Header = () => {
  return (
    <>
      {/* Row 1 */}
      <div className="flex justify-between border-b border-[#F4F4F4] w-full px-[24px]">
        {/* Breadcrumbs NavBar */}
      ...
      {/*  */}
      {/* Row 2 */}
      <div className="w-full border-b border-[#F4F4F4] px-[24px] flex justify-between items-center">
